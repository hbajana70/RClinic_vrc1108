...
// A generic type for our icon props
type IconProps = React.SVGProps<SVGSVGElement>;

// Fix: Changed props type from IconProps (for SVG) to ComponentProps<'div'> (for div)
// to resolve type mismatch on the root element. Also corrected className handling to
// merge classes from props instead of overwriting base classes.
export const RClinicLogo: React.FC<React.ComponentProps<'div'>> = (props) => (
    <div {...props} className={['flex items-center space-x-2', props.className].filter(Boolean).join(' ')}>
        <svg width="32" height="32" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg" className="text-primary">
            ...
            <path d="M2 17L7 14.5" stroke="currentColor" strokeWidth="2" strokeLinecap="round"/>
            <path d="M22 17L17 14.5" stroke="currentColor" strokeWidth="2" strokeLinecap="round"/>
        </svg>
        <span className="font-bold text-2xl text-dark-blue">RClinic</span>
    </div>
);
...
export const BeakerIcon: React.FC<IconProps> = (props) => (
    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" {...props}><path strokeLinecap="round" strokeLinejoin="round" d="M9.75 3.104v5.714a2.25 2.25 0 01-.659 1.591L5 14.5M9.75 3.104c-.251.023-.501.05-.75.082m.75-.082a24.301 24.301 0 014.5 0m0 0v5.714c0 .597.237 1.17.659 1.591L19.8 15.3M14.25 3.104c.251.023.501.05.75.082M19.8 15.3l-1.57.393A9.065 9.065 0 0112 15a9.065 9.065 0 00-6.23-.653L4.2 15.3M19.8 15.3l-1.57.393A9.065 9.065 0 0112 15a9.065 9.065 0 00-6.23-.653L4.2 15.3M6 18.75h12c.621 0 1.125-.504 1.125-1.125V15.3c0-1.01-1.01-1.83-2.076-1.623L12 15c-1.065.207-2.076-.613-2.076-1.623v-1.875c0-.621.504-1.125 1.125-1.125h3.375c.621 0 1.125.504 1.125 1.125v1.875" /></svg>
);
...
export const PresentationChartLineIcon: React.FC<IconProps> = (props) => (
    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" {...props}><path strokeLinecap="round" strokeLinejoin="round" d="M3.375 19.5h17.25m-17.25 0a1.125 1.125 0 01-1.125-1.125M3.375 19.5h7.5c.621 0 1.125-.504 1.125-1.125v-9.75c0-.621-.504-1.125-1.125-1.125h-7.5A1.125 1.125 0 002.25 7.5v9.75c0 .621.504 1.125 1.125 1.125zM10.875 8.625l2.25 4.5 4.5-6.75" /></svg>
);

export const ComputerDesktopIcon: React.FC<IconProps> = (props) => (
    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" {...props}><path strokeLinecap="round" strokeLinejoin="round" d="M9 17.25v1.007a3 3 0 01-.879 2.122L7.5 21h9l-1.621-.871a3 3 0 01-.879-2.122v-1.007M15 11.25a3 3 0 11-6 0 3 3 0 016 0z" /><path strokeLinecap="round" strokeLinejoin="round" d="M9.75 17.25h4.5a.75.75 0 00.75-.75V9.375c0-.621-.504-1.125-1.125-1.125H10.125c-.621 0-1.125.504-1.125 1.125v7.125c0 .414.336.75.75.75z" /></svg>
);
...
export const Cog6ToothIcon: React.FC<IconProps> = (props) => (
    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" {...props}><path strokeLinecap="round" strokeLinejoin="round" d="M9.594 3.94c.09-.542.56-1.007 1.11-1.226.55-.22 1.156-.22 1.706 0 .55.219 1.02.684 1.11 1.226M12 21.75c-1.378 0-2.673-.42-3.75-1.143M12 21.75c1.378 0 2.673-.42 3.75-1.143M12 21.75v-4.875A3.375 3.375 0 0115.375 13.5h.001c.481 0 .94.195 1.274.528.334.333.528.792.528 1.273v.001a3.375 3.375 0 01-3.375 3.375H12ZM8.625 13.5a3.375 3.375 0 00-3.375 3.375v.001c0 .481.195.94.528 1.273.334.333.793.528 1.274.528h.001A3.375 3.375 0 0012 16.875v-4.875c0-1.862-1.513-3.375-3.375-3.375h-.001Z" /></svg>
);

export const TicketIcon: React.FC<IconProps> = (props) => (
    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" {...props}><path strokeLinecap="round" strokeLinejoin="round" d="M16.5 6v.75m0 3v.75m0 3v.75m0 3V18m-9-1.5h5.25m-5.25 0h3m-3 0h.008M9 4.5h.008v.008H9V4.5Zm.008 3.75h.008v.008h-.008v-.008Zm.008 3.75h.008v.008h-.008V12Zm-3.766 4.498a2.25 2.25 0 01-2.25-2.25V6.75a2.25 2.25 0 012.25-2.25h10.5a2.25 2.25 0 012.25 2.25v9a2.25 2.25 0 01-2.25 2.25H5.242Z" /></svg>
);

export const BuildingStorefrontIcon: React.FC<IconProps> = (props) => (
    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" {...props}><path strokeLinecap="round" strokeLinejoin="round" d="M13.5 21v-7.5A.75.75 0 0114.25 12h.75a.75.75 0 01.75.75-2.25 2.25 0 004.5 0 .75.75 0 01.75-.75h.75a.75.75 0 01.75.75v7.5m-9-7.5h-2.25A.75.75 0 005.25 12h-.75a.75.75 0 00-.75.75-2.25 2.25 0 01-4.5 0A.75.75 0 00.75 12h-.75a.75.75 0 00-.75.75v7.5m9-7.5h-2.25A.75.75 0 005.25 12h-.75a.75.75 0 00-.75.75-2.25 2.25 0 01-4.5 0A.75.75 0 00.75 12h-.75a.75.75 0 00-.75.75v7.5M12 21v-7.5a.75.75 0 00-.75-.75H9.75a.75.75 0 00-.75.75v7.5" /><path strokeLinecap="round" strokeLinejoin="round" d="M12 21a9 9 0 009-9h-1.5a6.75 6.75 0 01-13.5 0H3a9 9 0 009 9zm-9-9a9 9 0 019-9v1.5a6.75 6.75 0 00-13.5 0V12zm18 0a9 9 0 00-9-9v1.5a6.75 6.75 0 0113.5 0V12z" /></svg>
);
...
export const UsersIcon: React.FC<IconProps> = (props) => (
    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" {...props}><path strokeLinecap="round" strokeLinejoin="round" d="M15 19.128a9.38 9.38 0 002.625.372 9.337 9.337 0 004.121-.952 4.125 4.125 0 00-7.533-2.493M15 19.128v-.003c0-1.113-.285-2.16-.786-3.07M15 19.128v.106A12.318 12.318 0 018.624 21c-2.331 0-4.512-.645-6.374-1.766l-.001-.109a6.375 6.375 0 0111.964-4.663v.005zM18 8.25a4.125 4.125 0 11-8.25 0 4.125 4.125 0 018.25 0zM9 8.25a4.125 4.125 0 11-8.25 0 4.125 4.125 0 018.25 0z" /></svg>
);

export const BuildingOffice2Icon: React.FC<IconProps> = (props) => (
    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" {...props}><path strokeLinecap="round" strokeLinejoin="round" d="M3.75 21h16.5M4.5 3h15M5.25 3v18m13.5-18v18M9 6.75h1.5m-1.5 3h1.5m-1.5 3h1.5m3-6h1.5m-1.5 3h1.5m-1.5 3h1.5M6.75 21v-2.25a2.25 2.25 0 012.25-2.25h6a2.25 2.25 0 012.25 2.25V21M6.75 3v2.25a2.25 2.25 0 002.25 2.25h6a2.25 2.25 0 002.25-2.25V3" /></svg>
);

export const ClipboardDocumentListIcon: React.FC<IconProps> = (props) => (
    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" {...props}><path strokeLinecap="round" strokeLinejoin="round" d="M9 12h3.75M9 15h3.75M9 18h3.75m3 .75H18a2.25 2.25 0 002.25-2.25V6.108c0-1.135-.845-2.098-1.976-2.192a48.424 48.424 0 00-1.123-.08m-5.801 0c-.065.21-.1.433-.1.664 0 .414.336.75.75.75h4.5a.75.75 0 00.75-.75 2.25 2.25 0 00-.1-.664m-5.8 0A2.251 2.251 0 0113.5 2.25H15c1.012 0 1.867.668 2.153 1.589m-9.346 0A2.25 2.25 0 005.25 2.25H7.5c1.012 0 1.867.668 2.153 1.589m-9.346 0a2.25 2.25 0 00-2.153 1.589L2.25 6.108V18.75c0 1.243 1.007 2.25 2.25 2.25h10.5a2.25 2.25 0 002.25-2.25v-4.132m-12 0c0-.621.504-1.125 1.125-1.125h2.25a1.125 1.125 0 011.125 1.125v2.25c0 .621-.504 1.125-1.125 1.125h-2.25A1.125 1.125 0 015.25 12V9.75z" /></svg>
);
...
export const CalendarDaysIcon: React.FC<IconProps> = (props) => (
    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" {...props}><path strokeLinecap="round" strokeLinejoin="round" d="M6.75 3v2.25M17.25 3v2.25M3 18.75V7.5a2.25 2.25 0 012.25-2.25h13.5A2.25 2.25 0 0121 7.5v11.25m-18 0A2.25 2.25 0 005.25 21h13.5A2.25 2.25 0 0021 18.75m-18 0h18M12 12.75h.008v.008H12v-.008zm0 3h.008v.008H12v-.008zm.008-3h.008v.008h-.008v-.008zm3 3h.008v.008h-.008v-.008zm-3 0h.008v.008H12v-.008zm-3.008 0h.008v.008h-.008v-.008z" /></svg>
);

export const CalculatorIcon: React.FC<IconProps> = (props) => (
    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" {...props}><path strokeLinecap="round" strokeLinejoin="round" d="M15.75 15.75V18m-7.5-6.75h.008v.008H8.25v-.008zm0 3h.008v.008H8.25v-.008zm0 3h.008v.008H8.25v-.008zm3-6h.008v.008h-.008v-.008zm0 3h.008v.008h-.008v-.008zm0 3h.008v.008h-.008v-.008zm3-6h.008v.008h-.008v-.008zm0 3h.008v.008h-.008v-.008zm0 3h.008v.008h-.008v-.008zm-7.5-6h.008v.008H8.25v-.008zm0 3h.008v.008H8.25v-.008zm0 3h.008v.008H8.25v-.008zM12 2.25c-5.385 0-9.75 4.365-9.75 9.75s4.365 9.75 9.75 9.75 9.75-4.365 9.75-9.75S17.385 2.25 12 2.25z" /></svg>
);

export const HeartPulseIcon: React.FC<IconProps> = (props) => (
    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" {...props}><path strokeLinecap="round" strokeLinejoin="round" d="M12.75 3.03v.568c0 .334.148.65.405.864l1.068.89c.442.369.535 1.01.216 1.49l-.51.766a2.25 2.25 0 01-1.161.886l-.143.048a1.107 1.107 0 00-.57 1.664c.369.555.169 1.307-.427 1.605L9 13.125l.423 1.059a.956.956 0 01-1.652.928l-1.068-.89a2.25 2.25 0 00-1.161-.886l-.143-.048a1.107 1.107 0 01-.57-1.664c-.369-.555-.169-1.307.427-1.605L12.75 3.03zM21 8.25c0-2.485-2.099-4.5-4.688-4.5-1.935 0-3.597 1.126-4.312 2.733-.715-1.607-2.377-2.733-4.313-2.733C5.1 3.75 3 5.765 3 8.25c0 7.22 9 12 9 12s9-4.78 9-12z" /></svg>
);
