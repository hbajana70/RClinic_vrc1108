...
import { RClinicLogo, UserIcon, KeyIcon, CalendarIcon, ClockIcon, PhoneIcon, EnvelopeIcon, CheckCircleIcon, XMarkIcon, CalendarDaysIcon } from './Icons';
import { APPOINTMENTS_DATA, SCHEDULE_USERS_DATA, SPECIALISTS_DATA, MEDICAL_CENTERS } from '../constants';
import type { Appointment, ScheduleUser, Specialist } from '../types';
